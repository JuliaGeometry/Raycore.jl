...
@kernel function raytrace_kernel_v1!(
    ...
    if x <= width && y <= height
        ...
        color = sample_light(bvh, ctx, width, height, camera_pos, focal_length, aspect, x, y, sky_color)
...
bench_kernel_v1 = @benchmark trace_gpu(raytrace_kernel_v1!, img_gpu, bvh_gpu, ctx_gpu, samples_per_pixel=4)
